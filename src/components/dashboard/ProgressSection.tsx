  ...
  return (
    <section className="px-4 py-6 md:px-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {/* Progresso Geral */}
        <div className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 backdrop-blur-sm rounded-xl p-4 border border-purple-500/20">
        ...
        {/* Aulas Completas */}
        <div className="bg-gradient-to-br from-green-900/40 to-green-800/20 backdrop-blur-sm rounded-xl p-4 border border-green-500/20">
          <div className="flex items-center gap-2 mb-2">
            <Trophy className="w-5 h-5 text-green-400" />
            <span className="text-sm text-gray-400">Completas</span>
          </div>
          <p className="text-2xl font-bold text-white">{completedLessons}</p>
          <p className="text-xs text-gray-500 mt-1">de {totalLessons} aulas</p>
        </div>

        {/* Tempo Assistido */}
        <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-sm rounded-xl p-4 border border-blue-500/20">
          <div className="flex items-center gap-2 mb-2">
            <Clock className="w-5 h-5 text-blue-400" />
            <span className="text-sm text-gray-400">Tempo</span>
          </div>
          <p className="text-2xl font-bold text-white">{hours}h {minutes}m</p>
          <p className="text-xs text-gray-500 mt-1">assistidos</p>
        </div>

        {/* Sequência */}
        <div className="bg-gradient-to-br from-orange-900/40 to-orange-800/20 backdrop-blur-sm rounded-xl p-4 border border-orange-500/20">
          <div className="flex items-center gap-2 mb-2">
